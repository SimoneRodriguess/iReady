    ...
    <>
        <section className="card-cta">
            <div className="flex flex-col gap-6 max-w-lg">
                <h2>Get interview Ready with iReady on the go!</h2>
                <p className="text-lg">
                    Practice on real interview questions and get immediate feedback!
                </p>
                <Button asChild className="btn-primary max-sm:w-full">
                    <Link href="/interview">Start an interview right away!</Link>
